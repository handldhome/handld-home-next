  ...
  return (
    <section id="how-it-works" className="section bg-gray-50">
      <div className="container">
        ...
        {/* Connector line for flow on desktop */}
        <div className="relative mt-10">
          <div className="hidden md:block absolute left-12 right-12 top-[38px] h-0.5 bg-brand-navy/20"></div>

          <div className="grid md:grid-cols-4 gap-6">
            {STEPS.map((s) => (
              <div key={s.n} className="card p-6 text-left relative">
                <div className="badge w-10 h-10">{s.n}</div>
